            ...
            <div className='w-3/4 mx-auto flex flex-col justify-between py-24'>
                <div className='grid grid-cols-2 gap-20 justify-between w-full mx-auto'>
                    <div className='w-full mr-8 flex flex-col'>
                        ...
                        <button className='bg-red-700 w-1/3 h-16 text-white font-semibold my-5'>Sign In</button>
                    </div>
                    ...
                    <div className='w-full mr-8 flex flex-col'>
                        ...
                        <button className='bg-green-400 w-1/3 h-16 text-white font-semibold my-5'>Create an Account</button>
                    </div>
                </div>
            </div>
        </div>
